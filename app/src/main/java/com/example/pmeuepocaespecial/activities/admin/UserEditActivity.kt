...
import com.example.pmeuepocaespecial.activities.user.LoginActivity
import com.example.pmeuepocaespecial.activities.user.ProfileEditActivity
...
class UserEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userId = intent.getIntExtra("projectId", 0)
